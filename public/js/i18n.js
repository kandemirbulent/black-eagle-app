(() => {
  ...
  const translations = {
    tr: {
      ...
      "index.hero.panelKicker": "Canlı Ekip Önizlemesi",
      "index.hero.panelTitle": "Müşterilerin en çok talep ettiği rollere hızlı bir bakış.",
      "index.hero.panelCopy": "Aşağıdaki okları kullanarak ana sayfa görselleri arasında gezebilir ve Black Eagle’ın canlı etkinlikler için sağlayabildiği hospitality ekiplerini önizleyebilirsiniz.",
      "index.hero.panelItem1.title": "Hospitality kapsamı",
      "index.hero.panelItem1.copy": "Bar, servis, mutfak ve güvenlik ekipleri dönen başlık alanında öne çıkarılır.",
      "index.hero.panelItem2.title": "Temizlik hizmetleri",
      "index.hero.panelItem2.copy": "Ev, ofis, dip temizlik, taşınma öncesi veya sonrası, düzenli ve tek seferlik temizlik desteği de sunulur.",
      "index.hero.panelItem3.title": "Esnek rezervasyon tipleri",
      "index.hero.panelItem3.copy": "Düğünler, özel etkinlikler, venue operasyonları ve düzenli hizmet desteği için uygundur.",
